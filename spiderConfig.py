...
-------------------------------------------------
    ...
    Description : 描述爬虫的相关配置文件
    Author      : tiancwyu
    date        : 2017/03/03
-------------------------------------------------
    Change Activity:
                    2017/03/03: Creat File
-------------------------------------------------
"""
import random
...
parserList = [
    {
        'urls': ['http://www.kuaidaili.com/proxylist/2/'],
        'type': 'lxml',
        'antispider':'kuai',
        'pattern': ".//*[@id='index_free_list']/table/tbody/tr[position()>0]",
        'position': {'ip': './td[1]', 'port': './td[2]', 'country': './td[6]', 'type': './td[4]'}
    }
    # {
    #     'urls': ['http://www.66ip.cn/2.html'],
    #     'type': 'lxml',
    #     'antispider':'none',
    #     'pattern': "//*[@id='main']/div/div[1]/table//tr[position()>1]",
    #     'position': {'ip': './td[1]', 'port': './td[2]', 'country': './td[3]', 'type': './td[4]'}
    #  }
]
